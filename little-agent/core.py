...
from episode import episode_worker
...
async def run(
    ...
    memory_queue = bus.subscribe(
        "memory",
        maxsize=1024,
    )

    episode_queue = bus.subscribe(
        "episode",
        maxsize=1024,
    )
